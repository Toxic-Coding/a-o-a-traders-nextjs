        ...
        <div className="max-w-[1500px] w-full mx-auto">
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              <h2 className="font-bold text-app_text text-4xl lg:text-[45px] lg:leading-[57px] mb-5">
                Successful!
              </h2>

              <h3 className="font-medium text-app_text text-xl sm:text-2xl mb-3">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 font-medium text-white bg-app_text py-3 px-6 rounded-md ease-out duration-200 hover:bg-app_text-app_text"
              >
                <svg
