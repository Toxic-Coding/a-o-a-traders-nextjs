  ...
  return (
    <>
      ...
      <section className="bg-app_bg py-[80px] px-[10px] sm:px-[20px]">
        <div className="max-w-[1500px] mx-auto w-full flex justify-center flex-col xl:flex-row gap-7.5">
          <div className="xl:max-w-[500px] w-full bg-white rounded-xl shadow-1">
            ...
            <div className="p-4 sm:p-7.5">
              <div className="flex flex-col gap-4">
                ...
                <p className="flex items-center gap-4">
                  <Mail width={24} height={24} className="text-app_blue" />
                  Email: Aoatradersinc@gmail.com
                </p>

                <p className="flex items-center gap-4">
                  <PhoneCall width={24} height={24} className="text-app_blue" />
                  Phone: (760) 590-4250
                </p>

                <p className="flex gap-4">
                  <MapPinned width={30} height={30} className="text-app_blue" />
                  Address: 124 S GEMSTONE SUITE A, Ridgecrest, California, USA -
                  93555
                </p>
                <p className="flex gap-4">
                  <AlarmClock
                  ...
                  />
                  Work time: Monday – Friday: 9:00-20:00 <br />
