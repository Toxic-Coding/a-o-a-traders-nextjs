  ...
  return (
    <div className="shadow-1 bg-white rounded-xl">
      <div className="px-4 sm:px-6 py-4.5 border-b border-gray-3">
        <h2 className="font-medium text-lg text-app_text">Search</h2>
      </div>
        ...
        <form>
          <div className="relative">
            <input
              ...
              className="w-full rounded-md border border-gray-3 py-3 pl-5 pr-13 outline-none ease-out duration-200 placeholder:text-app_text focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-app_blue"
            />
            <button className="text-app_text absolute right-0 top-0 px-4 py-3.5 ease-out duration-200 hover:text-app_blue">
              <svg
