            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                <span className="flex-shrink-0">
                  <MapPinned width={22} height={22} className="text-orange" />
                </span>
                124 S GEMSTONE SUITE A, Ridgecrest, California, USA - 93555
              </li>

              <li>
                <a href="#" className="flex items-center gap-4.5">
                  <PhoneCall width={22} height={22} className="text-orange" />
                  (760) 590-4250
                </a>
              </li>
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5">
                  <Mail width={22} height={22} className="text-orange" />
                  Aoatradersinc@gmail.com
                </a>
              </li>
            </ul>
