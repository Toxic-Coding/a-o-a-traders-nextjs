...
const config: Config = {
  ...
  theme: {
    ...
    colors: {
      ...
      productStart: "hsl(var(--color-product-start) / <alpha-value>)",
      productEnd: "hsl(var(--color-product-end) / <alpha-value>)",

      successStart: "hsl(var(--color-success-start) / <alpha-value>)",
      successEnd: "hsl(var(--color-success-end) / <alpha-value>)",

      errorStart: "hsl(var(--color-error-start) / <alpha-value>)",
      errorEnd: "hsl(var(--color-error-end) / <alpha-value>)",

      roleStart: "hsl(var(--color-role-start) / <alpha-value>)",
      roleEnd: "hsl(var(--color-role-end) / <alpha-value>)",
    },
    screens: {
      xsm: "375px",
      lsm: "425px",
